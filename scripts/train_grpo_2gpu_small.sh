...
python3 -u -m verl.trainer.main_ppo \
	...
	data.train_files=./data/kk/instruct/lithuanian_small/train.parquet \
	data.val_files=./data/kk/instruct/lithuanian_small/test.parquet \
	...
	trainer.project_name='grpo_kk_small_test' \
	trainer.experiment_name='grpo_qwen2_small' \
